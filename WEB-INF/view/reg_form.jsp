...
<title>Client  Registration- E-Loan Application</title>
...
<!----------------------------------------------------------------------------------------------->
<div class="box">
	<f:form action="registerClient" modelAttribute="command">
  <div class="container">
   

    <label for="email"><b>Name</b></label>
   <f:input path="user.name"  placeholder="Enter Username" class="input-type"/>

    <label for="psw"><b>Phone Number</b></label>
    <f:input path="user.phone" placeholder="Enter Phone number"   class="input-type"/>

    <label for="psw"><b>Email</b></label>
    <f:input path="user.email" placeholder="Enter Email"   class="input-type"/>
    
     <label for="psw"><b>Address</b></label>
     <f:textarea path="user.address" placeholder="Enter Address"   class="input-type"/>
    
    
     <label for="psw"><b>Username</b></label>
     <f:input path="user.loginName"  placeholder="Enter User Name"   class="input-type"/>
     
      <label for="psw"><b>Password</b></label>
       <f:password path="user.password" placeholder="Password"   class="input-type"/>
