...
<div class="grey-box">
	...
	<c:forEach var="t" items="${managerList}" >
	<tr>
	<td>${t.managerName}</td>
	<td>${t.password}</td>
	<td>${t.confirmPassword}</td>
	<td>${t.role}</td>
	<s:url var ="url_del" value="deleteManager">
	  <s:param name="uname" value="${t.managerName}"></s:param>
	</s:url>
	
	<s:url  var="url_edit" value="editManager">
	<s:param name="uname" value="${t.managerName}"></s:param>
	</s:url>
