...
<title>Clerk Registration- E-Loan Application</title>
...
<!----------------------------------------------------------------------------------------------->
<div class="box">
	<f:form action="registerClerk" modelAttribute="command">
  <div class="container">
   ...
   <f:input path="userName"  placeholder="Enter Username" class="input-type"/>
    ...
    <f:password path="confirmPassword" placeholder="Enter Confirm Password"   class="input-type"/>
    
     <label for="psw"><b>role</b></label>
     <f:input path="role" placeholder="Enter Role"   class="input-type"/>
